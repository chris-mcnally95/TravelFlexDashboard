...
### 
```{r}
flexdashboard::valueBox(value = totalcasessucc,
                        caption = paste0("Total Successful Reported Cases as of ", format(Sys.Date()-1, "%d-%m-%Y"), ". Unsuccessful cases included: ", totalcasesall),
...
### 
```{r}
flexdashboard::valueBox(value = FortCasesAllSucc,
                        caption = paste("Reported Successful Cases Within Previous Two epiweeks. Unsuccessful cases included: ", FortCasesAll),
                        icon = "ion-android-clipboard", 
                        color ="cornflowerblue")
```
...
flexdashboard::valueBox(value = totalNontravellercases,
                        caption = paste("Total Successful Non-Travel Related Cases as of ", format(Sys.Date()-1, "%d-%m-%Y")),
...
flexdashboard::valueBox(value = FortNonTravellers,
                        caption = paste("Reported Successful Non-Travel Related Cases in the Previous Two Epiweeks"),
                        icon = "ion-document-text", 
                        color ="cornflowerblue")
``` 

# Report Tables (Previous Two Weeks)
...
# Report Tables (One Epiweek Ago)

### All cases from Monday 00:00 on `r format(lubridate::floor_date(lubridate::today()-6, "week")+1, "%d-%m-%Y")` to 23:59 on Sunday `r format(lubridate::floor_date(lubridate::today(), "week"), "%d-%m-%Y")`.
...
# Report Tables (Two Epiweeks Ago)

### All cases from Monday 00:00 on `r format(lubridate::floor_date(lubridate::today()-13, "week")+1, "%d-%m-%Y")` to 23:59 on Sunday `r format(lubridate::floor_date(lubridate::today()-7, "week"), "%d-%m-%Y")`.
